...
public class SwerveModule {
  ...
  public SwerveModule(int moduleNumber, SwerveModuleConstants constants, boolean absoluteEncoderReversed) {
    ...
    absoluteEncoderOffsetDegrees = constants.absoluteEncoderOffsetDegrees;
  ...
  private void configureDevices() {
    ...
    angleEncoder.setPosition(Units.degreesToRadians(absoluteEncoder.getVoltage()) - absoluteEncoderOffsetDegrees);
